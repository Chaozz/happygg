...
TEST_F(SearchFixture, move_check) {
    ...
    chess_search->position_.FenToBoard(test_struct.position.fen_str, test_struct.position.move_num,
                                       test_struct.position.coord_list);
    ...
    chess_search->position_.FenToBoard(test_struct2.position.fen_str, test_struct2.position.move_num,
                                       test_struct2.position.coord_list);
